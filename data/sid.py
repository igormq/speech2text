    ...
    def get_data(self, root_dir, set_type):
        ...
        for curr_dir in search_dirs:
            ...
            assert os.path.isfile(
                (transcriptions_file)), "prompts.txt not found in {}".format(curr_dir)
            ...
            with open(transcriptions_file, 'r', encoding='utf8') as f:
                for line in f.readlines():
                    ...
                    if len(filtered_audio_paths) != 1:
                        print(
                            'Found zero or more than one audio file for the transcription id {} in '
                            '{}. Skipping...'.format(curr_id, transcriptions_file))
                        continue
