...
class CommonVoice(Corpus):
    ...
    DATASET_URLS = {
        "train": ["https://common-voice-data-download.s3.amazonaws.com/cv_corpus_v1.tar.gz"],
        "val": ["https://common-voice-data-download.s3.amazonaws.com/cv_corpus_v1.tar.gz"],
        "test": ["https://common-voice-data-download.s3.amazonaws.com/cv_corpus_v1.tar.gz"]
    }
    ...
    def get_data(self, root_dir, set_type):
        ...
        csv_path = os.path.join(root_dir, CommonVoice.FILES_TO_PROCESS[set_type])
